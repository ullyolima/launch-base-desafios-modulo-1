...
- <a href="#pushpin-primeiros-passos-com-javascript">Primeiros passos com JavaScript</a>
- <a href="#pushpin-lidando-com-objetos-e-vetores">Lidando com objetos e vetores</a>
- <a href="#pushpin-funções-e-estruturas-de-repetição">Funções e estruturas de repetição</a>
- <a href="#pushpin-aplicação-operações-bancárias">Aplicação: Operações bancárias</a>

## :pushpin: Tecnologias

- JavaScript

## :pushpin: Primeiros passos com JavaScript

**Cálculo de IMC** | [Resolução](/desafios-modulo-1/desafio-1_1.js)
...
**Cálculo de aposentadoria** | [Resolução](/desafios-modulo-1/desafio-1_2.js)
...
## :pushpin: Lidando com objetos e vetores

**Construção e impressão de objetos** | [Resolução](/desafios-modulo-1/desafio-2_1.js)
...
**Vetores e objetos** | [Resolução](/desafios-modulo-1/desafio-2_2.js)
...
## :pushpin: Funções e estruturas de repetição

**Usuários e tecnologias** | [Resolução](/desafios-modulo-1/desafio-3_1e2.js)
...
**Busca por tecnologia** | [Resolução](/desafios-modulo-1/desafio-3_1e2.js)
...
**Soma de despesas e receitas** | [Resolução](/desafios-modulo-1/desafio-3_3.js)
...
## :pushpin: Aplicação: Operações bancárias

**Intro** | [Resolução](/desafios-modulo-1/desafio-4.js)
...
**Adicionar transações** | [Resolução](/desafios-modulo-1/desafio-4.js)
...
**Relatórios** | [Resolução](/desafios-modulo-1/desafio-4.js)
...
Esse projeto está sob a licença MIT. Veja o arquivo [LICENSE](/desafios-modulo-1/LICENSE) para mais detalhes.